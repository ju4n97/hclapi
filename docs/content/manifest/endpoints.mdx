...
| `description`                  | `string` | no       | Used in logs and generated API documentation                   |
...
| `pipeline`                     | `block`  | yes      | Steps that handle the request                                  |
...
| `query`   | `ctx.request.query`   | Query string and defaults    |
