---
title: Installation
description: Install hclapi from a precompiled binary or the Go toolchain and verify the installation.
---
...
Download a binary for your platform from the [releases page](https://github.com/ju4n97/hclapi/releases).
